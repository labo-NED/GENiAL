...
def load_subject_ids(id_list_file):
    ...
    Args:
        id_list_file (str): Path to the file containing subject IDs (one per line)
    
    Returns:
        list: List of subject IDs (stripped of whitespace)
    """
    subject_ids = []
...
def move_files_from_list(source_dir, destination_dir, id_list_file):
    """
    ...
    Args:
        ...
        id_list_file (str): Path to file containing subject IDs
    """
    ...
    subject_ids = load_subject_ids(id_list_file)
    ...
    # Report on subject IDs that had no matches
...
def main(source_directory, destination_directory, id_list_file):
    """
    ...
    Args:
        ...
        id_list_file (str): Path to the file containing subject IDs
    """
    print("=== EEG File Moving Tool (Based on Subject ID List) ===")
    print(f"Source: {source_directory}")
    print(f"Destination: {destination_directory}")
    print(f"ID List: {id_list_file}")
    print("=" * 60)
    
    try:
        moved_items = move_files_from_list(source_directory, destination_directory, id_list_file)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Move files matching subject IDs from a list')
    ...
    parser.add_argument('id_list_file', help='Path to the file containing subject IDs (one per line)')
    
    args = parser.parse_args()
    main(args.source_directory, args.destination_directory, args.id_list_file)
